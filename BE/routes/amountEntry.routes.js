...
router.get("/amount-entries/:id", mongoIdParam, requirePermission("amounts.view"), getAmountEntryById);
...
router.patch("/amount-entries/:id", mongoIdParam, requirePermission("amounts.edit"), validateUpdateAmount, updateAmountEntry);
